...
contract Lottery is RrpRequesterV0, Ownable {
    ...
    mapping(bytes32 => bool) public pendingRequestIds; // mapping to store whether a fulfillment has been received for a given request
    ...
    /// @param requestId To mock the random number that was generated by the QRNG
